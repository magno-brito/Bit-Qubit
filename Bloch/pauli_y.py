...
# Definir a matriz Pauli-Y
Y = Qobj([[0, -1j], [1j, 0]])

# Criar estados intermediários aplicando frações da transformação Pauli-Y
states = []
steps = 20
for i in range(steps + 1):
    # Calcular o estado intermediário aplicando frações da Pauli-Y
    intermediate_state = (initial_state + i/steps * (Y * initial_state - initial_state)).unit()
